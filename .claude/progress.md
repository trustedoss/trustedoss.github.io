...
| 2     | 용어집 + 콘텐츠 직접 개선 | ✅ 완료                                                 |
| 3     | 실습환경                  | ✅ 완료                                                 |
| 4     | 데모환경                  | 🔄 진행중 (저위험 콘텐츠 완료, 데모 컴포넌트 설계 대기) |
...
**Phase 4 잔여 (설계 승인 후) — 고위험 컴포넌트:**

- 무API키 샘플 체험(canned 결과) TSX 컴포넌트, reference/samples 복사·다운로드 컴포넌트, 포털 live-demo 1클릭 연결
- website/src 신규 컴포넌트 작업이라 사용자 선택(저위험 먼저)에 따라 별도 설계 제안 후 진행 예정
