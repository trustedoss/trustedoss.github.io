...
| 2     | 용어집 + 콘텐츠 직접 개선 | ✅ 완료                                                        |
| 3     | 실습환경                  | ✅ 완료                                                        |
| 4     | 데모환경                  | 🔄 진행중 (저위험 콘텐츠 + 컴포넌트 A·C 완료, B 다운로드 대기) |
...
**Phase 4 잔여 — 컴포넌트 B(후속 결정):**

- reference/samples 복사·다운로드 컴포넌트(Docusaurus 기본 복사버튼 존재 → 다운로드가 갭). 사용자 선택(A+C 먼저)에 따라 B는 후속 논의
