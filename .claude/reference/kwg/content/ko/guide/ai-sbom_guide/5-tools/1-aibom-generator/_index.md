...
**그림 1.** OWASP AIBOM Generator 입력 화면 _(GenAI Security Project, 캡처 2026-06-13)_
...
**그림 2.** 생성 결과 화면 — 모델 정보, 라이선스(MIT), 완전성 평가(Basic) _(캡처 2026-06-13)_
...
**그림 3.** CLI 실행 출력 _(aibom CLI, 모델 facebook/bart-large-cnn, 실행 2026-06-13)_
