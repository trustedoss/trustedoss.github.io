...
### 프로세스 (G1.6, G2.2, G3L.2, G3L.5, G3L.6)
...
7. output/process/vulnerability-response.md — 취약점 대응 절차 (18974 §4.1.5.1, §4.2.1.2)
...
12. output/sbom/copyleft-risk.md — Copyleft 위험 분석 (5230 §3.3.2.1)
...
17. output/training/curriculum.md — 교육 커리큘럼 (5230 §3.1.1.2, 18974 §4.1.1.2)
18. output/training/completion-tracker.md — 이수 추적·역량 평가 증거 (5230 §3.1.2.3, 18974 §4.1.2.4)

### 인증 (G4.1~G4.5)

19. output/conformance/gap-analysis.md — 갭 분석 리포트 (5230 §3.6.2.1, 18974 §4.4.2.1)
...
완료 파일 수 / 전체 확인 대상 파일 수(18) \* 100 = 진행률(%)

이 18은 "존재 여부를 확인하는 산출물 파일 개수"이며, 07-conformance-preparer가 대조하는
"표준별 25개 세부 입증자료(총 50개)"와는 다른 단위다. 파일 하나가 여러 세부 항목의 근거가
되므로 18 ≠ 25다.

> 항목 9 (contribution-process.md)는 기여 계획이 없는 경우 N/A로 처리하며, 이 경우 분모는 17로 계산한다.
