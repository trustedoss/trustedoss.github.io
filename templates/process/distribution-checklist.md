...
> 이 프로세스 문서는 OpenChain KWG 프로세스 가이드(오픈소스 관리 프로세스의 배포 전 확인과 고지 단계)와 ISO/IEC 5230과 18974를 기준으로 작성되었습니다. KWG 가이드는 CC BY 4.0 라이선스입니다.
...
- [ ] 배포 이후 신규 CVE 모니터링이 개시되었는지 확인 (vulnerability-response.md 5절 참조)
