...
Generate the commands that match the language and package manager:

| Language    | Tool   | Docker command pattern                                                   |
| ----------- | ------ | ------------------------------------------------------------------------ |
...
| Other       | syft   | Use the general syft scan. If the result is empty, suggest trying cdxgen |
