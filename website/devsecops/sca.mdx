...
위 분석기는 한 번씩 결과를 확인하는 용도입니다. 팀 전체가 상시 운영하는 self-hosted SCA가 필요하면, 상용 도구 없이 SBOM 생성·취약점 추적을 자동화하는 [TrustedOSS Portal](https://trustedoss.github.io/trustedoss-portal/)로 이어갈 수 있습니다.

- 직접 띄워 보기: [포털 둘러보기](https://trustedoss.github.io/trustedoss-portal/) (Docker Compose로 약 5분 배포)
- 외부 공개용 체험 환경: [Read-only 데모 모드 구성 방법](https://trustedoss.github.io/trustedoss-portal/docs/installation/live-demo) — 쓰기를 막은 읽기 전용 데모를 직접 띄우는 가이드
