...
This section is an optional stage that **automatically applies the policies built in [Governance](/en/docs) to your code and CI pipeline**.
...
- To build a standards-based management system from the ground up, see the [Open Source Management Guide](/en/docs).
- To apply policies to AI coding tools (Cursor, Copilot, Claude Code, etc.), see [AI Coding Governance](/en/ai-coding/intro).
