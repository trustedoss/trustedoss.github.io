...
:::warning A scan passing and a scan checking are two different things
:::

Once an IaC scan is wired up, the badge turns green. Whether that green means "no violations" or "nothing was examined" is not something the badge can tell you. What follows are four cases from adding IaC scanning to [TRUSCA](https://github.com/trustedoss/trusca). In all four the display looked correct.
...
### Failing on something that never ships
...
All four displayed correctly. Green, or red with a plausible-sounding reason. What was wrong was not the verdict but the basis for it.
...
<iframe
  src="/tools/iac-sample-demo.html?lang=en"
  width="100%"
  height="680"
  frameBorder="0"
  style={{
...
<iframe
  src="/tools/iac-fixer.html?lang=en"
  width="100%"
  height="960"
  frameBorder="0"
  style={{
