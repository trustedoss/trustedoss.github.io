...
If you have already established an organizational Open Source Policy, see the [Developer Guide](/en/docs/developer-guide/) for automatically applying that policy to development.
:::
...
| CC-BY-SA       | Caution        | Content license, derivative-work scope undefined          |
