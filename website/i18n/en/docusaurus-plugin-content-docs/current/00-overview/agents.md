...
sidebar_position: 7
sidebar_label: Create outputs with AI agents
---
...
| Chapter           | Agent (`agents/…`)                 | Generated outputs                                                                                                                  |
| ----------------- | ---------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------- |
...
| 4 Process         | `04-process-designer`              | usage-approval, distribution-checklist, vulnerability-response, inquiry-response, (conditional) contribution / project-publication |
...
You can see the actual form of the generated outputs in [Policy Output Best Practices](/reference/samples/policy).
