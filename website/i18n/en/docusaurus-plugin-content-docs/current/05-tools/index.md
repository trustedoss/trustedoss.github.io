...
3. **Vulnerability analysis and response** — Use the SBOM to find and respond to known vulnerabilities (CVEs). The tools are grype and OSV. Go to [Vulnerability management](./vulnerability/index.md).
