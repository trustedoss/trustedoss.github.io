...
_이 리포트는 ISO/IEC 5230 §3.1.5(라이선스 의무사항 식별·검토), §3.3.2(라이선스 사용 사례 처리) 및 §3.4.1(컴플라이언스 산출물) 요구사항을 충족하기 위해 생성되었습니다._
...
_이 리포트는 ISO/IEC 5230 §3.1.5(라이선스 의무사항 식별·검토)와 §3.3.2(라이선스 사용 사례 처리) 요구사항을 충족하기 위해 생성되었습니다._
...
- 인코딩: JSON
- 생성 도구: [ 사용한 도구명 및 버전 ]
- 검증: `pyspdxtools -i <파일명>` (spdx-tools)
