...
| 🟡 Medium   | 4.0 ~ 6.9  | 3개월 이내  | 다음 정기 릴리즈에 포함   | Major         |
| 🟢 Low      | 0.1 ~ 3.9  | 다음 릴리즈 | 정기 업데이트 시 반영     | Minor         |

:::info[참고]
위 기한 중 Critical과 High는 OpenChain KWG 가이드 기준선이고, Medium과 Low는 trustedoss 권고입니다. 조직의 리스크 프로파일과 역량에 따라 더 엄격한 기한(Critical 24시간·High 1주일 등)을 내부 SLA로 적용할 수 있습니다.
