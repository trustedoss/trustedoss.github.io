...
오픈소스 관리 경험이 전혀 없는 신규 담당자도 이 키트를 따라가면 ISO/IEC 5230과 18974 자체 인증 선언까지 완성할 수 있습니다. Agent가 회사 상황에 맞는 산출물을 자동 생성하며, 셀프스터디와 하루 워크숍 두 가지 방식으로 활용할 수 있습니다.
...
| 방법 | 대상 | 소요시간 | 시작 방법 |
|------|------|--------|---------|
| **셀프스터디** | 혼자서 학습하고 싶은 담당자 | 며칠 (8–12시간) | `docs/00-overview/` 부터 순서대로 |
| **워크숍** | 강사와 함께 팀 실습 | 하루 (7시간 30분) | `workshop/student-handout.md` 참고 |
...
| 04-process | 오픈소스 프로세스 설계 | 1시간 | M2 |
| 05-tools/sbom-generation | SBOM 생성 | 1시간 | M3 |
| 05-tools/sbom-management | SBOM 관리 및 공유 | 1시간 | M4 |
| 05-tools/vulnerability | 취약점 분석 및 대응 | 1시간 | M5 |
| 06-training | 교육 체계 구축 | 30분 | M6 |
| 07-conformance | 자체 인증 선언 | 30분 | M6 |
