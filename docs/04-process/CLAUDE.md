...
| G2.2        | 외부 문의 대응 절차              | 3.2.1        | 4.2.1         |
| G3L.2       | 라이선스 의무사항 이행           | 3.3.2        | —             |
| G3L.5       | 컴플라이언스 산출물 보관 절차    | 3.4.1        | —             |
| G3L.6       | 오픈소스 기여 관리 절차          | 3.5.1        | —             |
| G3S.1~G3S.4 | 취약점 탐지·대응·CVD 절차        | —            | 4.1.5         |

> 이 단계는 ISO/IEC 5230 3.1.5, 3.2.1, 3.2.2, 3.3.2, 3.4.1, 3.5.1 및 ISO/IEC 18974 4.1.5, 4.2.1 요구사항을 충족합니다.
...
- [ ] `output/process/contribution-process.md` 생성됨 (외부 기여 계획이 있는 경우)
- [ ] `output/process/project-publication-process.md` 생성됨 (사내 프로젝트 공개 계획이 있는 경우)
...
2. 소프트웨어 배포 주기 (매일/주간/격주/월간/비정기)
3. 이슈 트래커 사용 여부 (GitHub Issues/Jira/없음/기타)
4. 오픈소스 사용 승인 결재 단계 (담당자 단독/팀장 승인/위원회 승인)
5. 외부 오픈소스 프로젝트 기여 계획 여부 (예 시 기여 절차 문서 생성)
6. 사내 소프트웨어 오픈소스 공개 계획 여부 (예 시 공개 절차 문서 생성)
7. 외부 라이선스·취약점 문의 수신 채널 준비 여부
