...
4. **워크숍 모듈 매핑** → M0~M6 모듈과 챕터 연결 관계 확인
5. **요약 통계** → 전체 25개 항목 현황 숫자로 확인
...
3. 두 경로(셀프스터디/워크숍) 중 선택
4. `docs/00b-supply-chain/` 으로 이동하여 배경 지식 습득

## 워크숍 경로

:::tip 워크숍 모드 (M0 오리엔테이션 - 30분)
전체 팀과 함께 이 문서를 리뷰하고 담당자를 사전 지정합니다.
:::

1. (10분) 두 표준 비교 표 팀 리뷰
2. (10분) 워크숍 모듈 매핑 확인 — M1~M6 일정 확인
3. (10분) 역할 분담 사전 논의 (다음 M1 모듈 준비)
...
- **셀프스터디**: `docs/00b-supply-chain/` 읽기 (배경 지식)
- **워크숍**: M0 완료 후 M1 모듈 시작 (`docs/02-organization/`)
