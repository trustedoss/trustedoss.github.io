...
그룹별로 어느 챕터가 무엇을 채우는지는 [표준 요구사항 한눈에](./checklist-mapping.md)에 표로 정리돼 있습니다. 항목 하나하나의 인증 질문과 입증자료가 필요해지는 시점은 [07 인증](../07-conformance/index.md)이며, 그때 [요구사항 상세 대조표](/reference/requirements-matrix)를 펼칩니다.
