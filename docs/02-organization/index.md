...
4. Claude 프롬프트가 열리면 **`시작`** 을 입력하세요. agent가 6개 질문을 순서대로 진행합니다.
   ...
   **Agent 안내 메시지:**
   ...
   6개 질문에 답변하시면 3개의 산출물 파일이 자동으로 생성됩니다.
   ```
   ...
   **질문 4/6** — 법무 자문이 있나요? (없음 / 자체 법무팀 / 외부 법무 법인 활용 중 / 외부 법무 법인 활용 예정)
   ...
   **질문 6/6** — 외부 오픈소스 프로젝트에 기여하거나 사내 프로젝트를 오픈소스로 공개할 계획이 있나요? (기여만 / 공개만 / 둘 다 / 없음)
...
5. 위 대화 예시의 6개 질문에 자사 상황에 맞게 답변
