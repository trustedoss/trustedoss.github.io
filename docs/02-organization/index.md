...
> 📋 **산출물 예시**: [조직 산출물 Best Practice](/reference/samples/organization)에서 생성된 파일의 실제 형식을 확인할 수 있습니다.
...
또는 [오픈소스 정책 수립: 법적 보호의 첫걸음](../03-policy/index.md)으로 이동하여 정책 챕터를 먼저 읽은 뒤 진행할 수 있습니다.
