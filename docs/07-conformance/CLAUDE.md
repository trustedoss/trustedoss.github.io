...
| G4.2 | ISO/IEC 18974 자체 인증 선언 | — | 3.4.1 |
| G4.3 | 인증 유효기간 관리 (18개월) | 3.6.2 | 3.4.2 |
| G4.4 | 정기 갭 분석 및 정책 갱신 | 3.6.2 | 3.4.2 |

> 이 단계는 ISO/IEC 5230 3.6.1, 3.6.2 및 ISO/IEC 18974 3.4.1, 3.4.2 전체 요구사항을 충족합니다.
